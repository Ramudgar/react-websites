...
function EmpHome() {
    ...
    <div className="d-md-flex">
        <ul id="navbar-items" className="p-0">
            ...
            <li> <span className="fas fa-chart-line"></span> <span className="ps-3 name">Create Jobs</span> </li>
            <li> <span className="fas fa-chart-line"></span> <span className="ps-3 name">View Jobs</span> </li>
            <li> <span className="fas fa-clipboard-check"></span> <span className="ps-3 name">Profile</span> </li>
